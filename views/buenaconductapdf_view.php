...
$restriccion=$constancia->verificarRestriccionConstancia(date('m'),'Buena conducta',$_REQUEST['dni']);
if($restriccion==0)
...
<?php echo "con residencia en la comunidad de:<b> ".$ciudadano[0]['direccion'].", Sector \"".$ciudadano[0]['sector']."\",";
if(empty($ciudadano[0]['numero_casa']))
	echo " casa S/N";
else
	echo " casa N° ".$ciudadano[0]['numero_casa'];
echo ", Parroquia ".$ciudadano[0]['nombre_parroquia'].", Municipio ".$ciudadano[0]['nombre_municipio'].", Carúpano Estado ".$ciudadano[0]['nombre_estado']."</b>, damos fe de conocer de vista, trato y comunicación, demostrando una factibilidad moral, se considera una persona responsable, colaboradora y servidora antes nuetra comunidad.";?>
</div>
<div id='cuerpo2'>
