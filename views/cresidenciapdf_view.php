...
<div>
<div id='cuerpo'>
<?php echo "Quien suscribe, Consejo Comunal ".$config[0]['nombre_consejo_comunal'].", ubicado en ".$config[0]['direccion'].", Parroquia ".$config[0]['parroquia'].", Municipio ".$config[0]['municipio'].", ".$config[0]['ciudad']." Estado ".$config[0]['estado']."
