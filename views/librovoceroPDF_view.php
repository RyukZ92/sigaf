...
<div id='cuerpo2'>
Constancia que se expide de parte interesada en la ciudad de <?php echo $config[0]['ciudad']; ?> Estado <?php echo $config[0]['estado']; ?> el día <?php echo date('d')." del mes de ".$mes." de ".date('Y')."."; ?> 
</div>
</div>
